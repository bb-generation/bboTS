...
/**
 * Exception thrown by {@link BOTeamSwitcher}
 * 
 * @author Bernhard Eder
 *
 */
public class BOTeamSwitcherException extends Exception
{
	private static final long serialVersionUID = 1L;

	public BOTeamSwitcherException()
	{
		super();
	}
	
	public BOTeamSwitcherException(String err)
	{
		super(err);
	}
}